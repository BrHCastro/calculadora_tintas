class Calculadora:
    __area_paredes: float  # Atributos iniciam com __ são declarados como privados.
    __area_teto: float
    ...
    def calcular_litragem_necessaria(self):
        return (self.__area_paredes + self.__area_teto) / 10  # 10 é o rendimento da tinta. 10m² / lt
